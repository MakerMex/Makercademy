...
Bienvenido al sistema educativo Makercademy, en este tu primer año nos enfocaremos a conocer ampliamente la tarjeta [circuit playground express](http://learn.makercademy.com/modules/referencias/acp/) y [MakeCode](http://learn.makercademy.com/modules/referencias/Makecode/).
...
¿quieres saber más sobre tu nueva tarjeta? 
